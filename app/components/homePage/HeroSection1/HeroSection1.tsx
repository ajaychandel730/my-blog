...
const HeroSection1 = async () => {
  ...
  return (
    <div className="w-full grid grid-col-2 space-y-4 lg:grid-cols-3 gap-2 min-h-[600px]">
      <section aria-labelledby="most-latest-blogs" className="lg:col-span-2 space-y-10">
        <MostRecentBlogs />
