...
const AboutHeroSection = () => {
  return (
    <section className="bg-gradient-to-b mt-20 from-blue-200 to-gray-100  dark:bg-none rounded-t-lg p-8 text-center flex flex-col items-center  dark:rounded-lg dark:bg-midnight-900 ">
